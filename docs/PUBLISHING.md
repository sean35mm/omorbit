...
`https://github.com/sean35mm/omarchy-workspace-picker`

The stable plugin ID is `io.github.sean35mm.workspace-picker`. The root contains the standalone manifest, README, license, QML entry point, and safe install/removal instructions; clone-only `omarchy.clonedFrom` metadata is intentionally absent.

## Before publishing

- [ ] Create the public GitHub repository and review the exact files to publish.
...
- [ ] Test `omarchy-shell shell summon io.github.sean35mm.workspace-picker '{}'` and `omarchy-shell shell hide io.github.sean35mm.workspace-picker`.
...
- **Code repository:** https://github.com/sean35mm/omarchy-workspace-picker
